...
class AnalysisDetail(BaseModel):
    ...
    """
    kpi_name: str = Field(..., description="KPI 이름 (예: RACH Success Rate)")
    value: float = Field(..., description="측정된 KPI 값")
...
class AnalysisResultBase(BaseModel):
    ...
    ne_id: str = Field(..., description="Network Element ID", alias="neId")
    cell_id: str = Field(..., description="Cell ID", alias="cellId")
